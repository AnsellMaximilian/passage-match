...
export default function Card({ flipped, card, handleChoice, disabled }: Props) {
  ...
  return (
    <div
      className="w-40 h-48 [perspective:1000px] group bg-transparent cursor-pointer"
      onClick={handleClick}
    >
      <div
      ...
      >
        <div className="p-3 bg-[#C9D8FF] rounded-lg flex flex-col h-full w-full absolute [backface-visibility:hidden]">
        ...
        <div className="h-full w-full absolute rounded-lg [transform:rotateY(180deg)] [backface-visibility:hidden] bg-[#4565B6] bg-gradient-radial to-[#1a285f] from-[#4565B6]">
          <div className="w-full h-full rounded-lg flex items-center justify-center">
            <div className="w-28 h-28 bg-[#C9D8FF] rounded-full flex items-center justify-center">
